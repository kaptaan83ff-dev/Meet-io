        ...
        <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#0f1014]/80 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <Link to="/login" className="hidden sm:flex items-center px-4 text-sm font-medium text-gray-300 hover:text-white transition-colors">
                        Sign in
                    </Link>
                    <Link to="/login" className="bg-white text-black px-6 py-3 flex items-center justify-center rounded-full text-sm font-bold hover:bg-gray-200 transition-colors shadow-sm">
                        Get Started
                    </Link>
                </div>
            </div>
