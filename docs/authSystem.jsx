...
import { Mail, Lock, User, ArrowRight, Github, Chrome, Eye, EyeOff, CheckCircle2 } from 'lucide-react';
...
const InputField = ({ label, type, placeholder, icon: Icon, value, onChange }) => {
  ...
  return (
    <div className="space-y-2">
      ...
      <div 
        className={`relative flex items-center bg-[#1E2330] rounded-xl border transition-all duration-300 ${
          isFocused 
...
// 3. Feature Card (Decorative element for the left side)
const FeatureCard = ({ title, subtitle, gradient, icon: Icon, delay }) => (
  <div 
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] flex items-center justify-center p-4 lg:p-8 font-sans selection:bg-orange-500/30 selection:text-orange-200">
      ...
      {/* Background Ambience (Blurry blobs matching the dashboard colors) */}
          ...
          <div className="relative z-10">
             ...
             <div className="flex items-center gap-3 mb-12">
                ...
                <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">
                  Connect<span className="text-blue-500">.</span>
                </span>
             </div>
